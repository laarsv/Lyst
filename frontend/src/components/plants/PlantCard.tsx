 ...
 *  species, a small watering due indicator (danger-tinted when overdue), and
 *  the Bereich tag pills. White card, ~18px radius, hairline border, no heavy
 *  shadow — per the approved design. */
